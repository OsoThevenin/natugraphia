	...
	const sections = [
		...
		},
		{
			...
			links: [
				...
				{
					label: t("legal.returnsPolicy"),
					href: "/legal/returns",
				},
				{
					label: t("legal.shippingPolicy"),
					href: "/legal/shipping",
				},
				{
					label: t("legal.cookiePolicy"),
					href: "/legal/cookies",
				},
				{
					label: t("legal.gdpr"),
			...
			links: [
				{
					...
					href: "mailto:info@natugraphia.com",
				},
			],
		},
	];
...
function GithubIcon(props: SVGAttributes<SVGSVGElement>) {
	return (
		<svg {...props} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 250">
			<g>
				<path
					fill="#161614"
